      ...
      <div>
        ...
        <Grid fluid className={s.detailscontainer}>
          <Row className={s.details}>
            <Col xs={12} sm={6} className={s.alignRight}>
              ...
              <p>We envision humans and machines bringing nature in to balance and uplifting the human condition and we&rsquo;re initially only accepting Bitcoin Cash because we believe in Satoshi&rsquo;s vision of a currency for the world&rsquo;s unbanked.</p>
              <p>To order a clone send $1,000 USD in Bitcoin Cash to <strong>3D8sBLyTeBbwJpCR3KcAvNzgWo3CTJqiMM</strong>. Then send the transaction id to <strong>buy@clone.earth</strong>. You&rsquo;ll get back a confirmation email shortly and your Clone will begin getting made.</p>
        ...
        <Grid fluid>
          <Row className={s.detailsqr}>
            <Col xs={12}>
              <p>3D8sBLyTeBbwJpCR3KcAvNzgWo3CTJqiMM</p>
              <p>
